...
Antes das instruções para utilização, é necessário verificar se você possui Git instalado em sua máquina, ou baixar este repositório compactado, conforme a imagem abaixo. 
